...
<qgis version="3.34.14-Prizren">
  <identifier>fix_jalan</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>fix_jalan</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="File Geodatabase Feature Class" mimeType="" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" description="" format="" type="Local Area Network" size=""/>
  </links>
  <dates/>
  <fees></fees>
